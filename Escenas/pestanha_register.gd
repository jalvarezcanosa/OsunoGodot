...
@onready var usuario_input = $line_edit_usuario
@onready var contrasenha_input = $line_edit_contrasenha
@onready var confirmar_input = $line_edit_confirmar_usuario
@onready var boton_registrar = $Boton_Registro
@onready var boton_volver = $Boton_volver_login
@onready var http = $HTTPRequest  # Nodo HTTPRequest ya en la escena
...
func _enviar_peticion_registro(datos: Dictionary):
	# ¡SIMPIFICADO! Usamos el nodo http que ya está en la escena
